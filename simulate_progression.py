...
def simulate_progression(Lambda_a, Lambda_b):
    T = 0.0
    score_a = 0
    score_b = 0
    ...
    while True:
        ...
        if random_uniform() < Lambda_a / (Lambda_a + Lambda_b):
            ...
            score_b += 1
        #print("T: {}, score_a: {}, score_b: {}".format( T, score_a, score_b))
        progression.append((score_a, score_b))

def simulate_progression_data(Lambda_a, Lambda_b, num_simulations=10000000):
    progressions = []
